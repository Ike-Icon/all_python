import random
def main():
    """Write the main function to call your make_sentence function
     six times and print six sentences with these characteristics:
     Quantity	Verb Tense
     a.	single	past
     b.	single	present
     c.	single	future
    ...
    sentences = make_sentence(1, "present")
    print(sentences)

    sentences = make_sentence(1, "future")
    print(sentences)

    sentences = make_sentence(2, "past")
    print(sentences)

    sentences = make_sentence(2, "present")
    print(sentences)

    sentences = make_sentence(2, "future")
    print(sentences)
